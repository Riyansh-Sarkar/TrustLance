...
🔗 **Google Form:** [User Onboarding Form](https://forms.gle/dRnduvqg7TYt6eU96)
📊 **Response Sheet:** [Response Sheet](https://docs.google.com/spreadsheets/d/1QzTLGm0k9ioJwqTkJEcI66oB8eY-i50d/edit?usp=sharing&ouid=117492014114035182400&rtpof=true&sd=true)
---

| #  | Name                 | Email                        | Wallet Address                                             | Feedback                                                                                            | Improvement Made                                                                                                                                                                                                                                                                  |     Rating    | Git Commit                                                                                                |
| -- | -------------------- | ---------------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------: | --------------------------------------------------------------------------------------------------------- |
| 1  | **Aditya Jha**       | `jha073803@gmail.com`        | `GDFKLTB5WKKDDJ2NRU2V5OG476HYEGWT4UFV7BID7BNGWZGRZYL3LL6Z` | Maybe a few more customization options in the UI, otherwise great as is.                            | Improved the **profile and customization experience**, with more reliable profile state handling and a cleaner personalized user experience across TrustLance.                                                                                                                    | ⭐⭐⭐⭐⭐ **5/5** | [`91e400d`](https://github.com/Riyansh-Sarkar/TrustLance/commit/91e400da4da397bf590cc6fb3c1bb910b2bce2e8) |
| 2  | **Souvik Mandal**    | `souvikmandals10@gmail.com`  | `GAG3SUKHIF7VAWGTDRH52XETMLZXXNXBAZLLXHSLXAQPOBBCN43YLKR4` | Adding multi-wallet integrations instead of only Freighter.                                         | Expanded the **Stellar wallet integration experience** to provide broader wallet support and make wallet connectivity less dependent on a single wallet provider.                                                                                                                 | ⭐⭐⭐⭐☆ **4/5** | [`924a229`](https://github.com/Riyansh-Sarkar/TrustLance/commit/924a229d7c71d572f0a2a5e94247e24a8ebff87d) |
| 3  | **Ankita Barman**    | `poulumidui@gmail.com`       | `GCV5X5CKYUAPQLE3OYQS3PDXKX4TRV767YUCJ66PWWGZD2BXE744T276` | The connected wallet address looks broken.                                                          | Improved wallet presentation by displaying long addresses in a **clean shortened format with an ellipsis (`…`)**, while keeping the wallet easier to identify throughout the UI.                                                                                                  | ⭐⭐⭐⭐⭐ **5/5** | [`414278b`](https://github.com/Riyansh-Sarkar/TrustLance/commit/414278bba8307588aaa10406a435fcf335688f68) |
| 4  | **Debansh Tiwari**   | `debanshtiwari712@gmail.com` | `GA4SXARZZ4RPF6N7VOAH3B5OKMFAP3FGY6M6TO3DZJL4TMU2KOVBHCIY` | Nothing major comes to mind, perhaps a dark mode option.                                            | Added and refined **dark-mode/theme support**, giving users a more comfortable alternative appearance while keeping the interface visually consistent.                                                                                                                            | ⭐⭐⭐⭐⭐ **5/5** | [`61535ac`](https://github.com/Riyansh-Sarkar/TrustLance/commit/61535ac7078e26897b5d8fb73d428e5db2f08014) |
| 5  | **Priyasha Debnath** | `popololo229099@gmail.com`   | `GCKMODNZEAI4X6AL6SL77PNJLUUJAQAWECXDTXJZGXBOSSSF7THC3XH6` | Occasional delays when loading certain pages; would like realtime microservices for faster updates. | This feedback identifies a **future real-time data/performance improvement**. None of the five provided commits directly demonstrates implementation of a realtime microservices architecture, so it should remain an improvement target rather than be linked to unrelated code. | ⭐⭐⭐☆☆ **3/5** | —                                                                                                         |
| 6  | **Papita Kumari**    | `poppritu@gmail.com`         | `GACMLTEWZ23NGJ5WZ2THYGLODFYTEKECB7J2U33H3DCSW2PEAQUEIZED` | Keep the design consistent, maybe add a few more themes.                                            | Improved the application's **theme experience and visual consistency**, including dark-mode styling that gives TrustLance a more cohesive appearance across key screens.                                                                                                          | ⭐⭐⭐⭐⭐ **5/5** | [`61535ac`](https://github.com/Riyansh-Sarkar/TrustLance/commit/61535ac7078e26897b5d8fb73d428e5db2f08014) |
| 7  | **Probir Sha**       | `proumg2@gmail.com`          | `GAEAB4UWRUODGUKBYGDXBZULSOI3HJ6HQKJNNLTY66IF3ATXMRYUCSNX` | More filters and detail in the analytics dashboard would be great.                                  | This is a valid **analytics enhancement request**, but the supplied commits do not directly provide evidence of additional analytics filters or expanded analytics functionality. It is best recorded as a next iteration item.                                                   | ⭐⭐⭐⭐☆ **4/5** | —                                                                                                         |
| 8  | **Amitabh Dey**      | `amitabh101dey@gmail.com`    | `GBKYHWSL2MNUO73HWY6KWNOA64AKSUENCOBTR56M66HNLMMKMZHK5OAS` | Keep enhancing the Stellar integration further.                                                     | Strengthened the **Stellar wallet integration layer**, improving the wallet connectivity experience and extending how users can interact with TrustLance through Stellar wallets.                                                                                                 | ⭐⭐⭐⭐⭐ **5/5** | [`924a229`](https://github.com/Riyansh-Sarkar/TrustLance/commit/924a229d7c71d572f0a2a5e94247e24a8ebff87d) |
| 9  | **Abhishek Kumar**   | `ak0001736@gmail.com`        | `GBENUMINONHMCBALY7UMD4JQV7XXOQHAO4KNVV4UJC5ZTGHNE7PWQ7HR` | Nothing specific right now, overall satisfied.                                                      | No specific issue was reported; broader **profile, customization, and user-state reliability refinements** were continued while preserving the existing workflow users were satisfied with.                                                                                       | ⭐⭐⭐⭐⭐ **5/5** | [`91e400d`](https://github.com/Riyansh-Sarkar/TrustLance/commit/91e400da4da397bf590cc6fb3c1bb910b2bce2e8) |
| 10 | **Pritam Dev**       | `pritamsdev2@gmail.com`      | `GATJMD6BGNK4FQYNFWB354N7RP4XHA2R74GNSYM472ALNLJFX7NXBS3X` | Maybe add a few in-app tutorials for new users.                                                     | This feedback remains a **beginner-onboarding improvement opportunity**. The supplied commits do not directly demonstrate implementation of an in-app tutorial or guided product tour, so it should not be attributed to an unrelated commit.                                     | ⭐⭐⭐⭐⭐ **5/5** | —                                                                                                         |

### 📌📈 User Feedback & Improvements Summary

Based on real Stellar Testnet user feedback, **TrustLance** was iteratively improved across wallet usability, personalization, theme support, Stellar connectivity, and overall user experience.

Key improvements include:

- 👤 **Profile & Customization Improvements** — Improved profile handling and personalization so users have a cleaner and more reliable account experience.
- 🌙 **Dark Mode & Theme Support** — Added and refined dark-mode styling to improve visual comfort and interface consistency.
- 👛 **Wallet Address Display Fix** — Improved long wallet-address presentation using a cleaner shortened format for better readability.
- 🔗 **Multi-Wallet & Stellar Integration** — Strengthened Stellar wallet connectivity and expanded the wallet experience beyond a single-provider flow.
- 🎨 **UI Consistency Enhancements** — Improved theme structure, layout consistency, and presentation across important TrustLance screens.
- ⚡ **Performance Feedback Identified** — User feedback highlighted the need for faster real-time updates and reduced loading delays, which remains an important next iteration area.
- 📊 **Analytics Improvement Identified** — Users requested deeper analytics and additional filters, providing a clear roadmap for future dashboard enhancements.
- 📘 **Beginner Onboarding Opportunity** — Feedback also identified the value of in-app tutorials and guided onboarding for first-time users.

> **10 real user feedback responses were reviewed and mapped to implemented improvements where matching Git evidence exists, while remaining requests were retained as transparent future improvement targets. This demonstrates continuous, feedback-driven development of TrustLance.**
